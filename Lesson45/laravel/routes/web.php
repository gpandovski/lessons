...
Route::put('/articles/{article}', 'ArticlesController@update'); // /article  -> update in database
...
Route::get('/articles/create', 'ArticlesController@create'); // show form to create article
